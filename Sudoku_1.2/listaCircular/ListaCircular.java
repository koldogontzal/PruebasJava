...
public class ListaCircular<E> {
	...
	public void add(E elemento) {
		// La lista queda truncada al alemento actual, se borrar�n los siguientes a �l (los m�s nuevos)
	...
	public E actual() {
		if (this.posAct != -1) {
			...
			System.out.println("ERROR ListaCircular.actual(): La lista est� vac�a.");
			return null;
		}
	}
